      ...
      <main>
        ...
        <div className="w-40-ns w-90 center flex flex-column vh-100-ns justify-center">
          ...
          <div className="pv7 bt bb b--muted-3 t-heading-2-ns fw3-ns t-heading-3 fw3 pointer dim">
            <a className="c-on-base"><span className="c-emphasis">1.</span> Dreamstore Announcement</a>
          </div>
          <div className="pv7 bb b--muted-3 t-heading-2-ns fw3-ns t-heading-3 fw3 pointer dim">
            <a className="c-on-base"><span className="c-emphasis">2.</span> Dreamstore Getting Started</a>
          </div>
          <div className="pv7 bb b--muted-3 t-heading-2-ns fw3-ns t-heading-3 fw3 pointer dim">
            <a className="c-on-base"><span className="c-emphasis">3.</span> Style Builder</a>
          </div>
          <div className="pv7 bb b--muted-3 t-heading-2-ns fw3-ns t-heading-3 fw3 pointer dim">
            <a className="c-on-base"><span className="c-emphasis">4.</span> Store Builder</a>
          </div>
          <div className="pv7 bb b--muted-3 t-heading-2-ns fw3-ns t-heading-3 fw3 pointer dim">
            <a className="c-on-base"><span className="c-emphasis">5.</span> Contributing.md</a>
          </div>
        </div>
      </main>
    )
